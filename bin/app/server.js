...
const postgresConnectionPooling = require('../helpers/databases/postgresql/connection');
...
function AppServer() {
  ...
  this.server.put('/api/articles/v1/edit/:id', jwtAuth.verifyToken, articleHandler.editArticle);
  this.server.del('/api/articles/v1/delete/:id', jwtAuth.verifyToken, articleHandler.deleteArticle);


  //Initiation
  postgresConnectionPooling.init();
}
